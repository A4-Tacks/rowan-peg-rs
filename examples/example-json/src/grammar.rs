...
::peg::parser!(pub grammar parser<'b>(state: &'b ::rowan_peg_utils::ParseState<'input>) for str {
    ...
    rule ws() = ()(()(g:({state.guard_none()})((g:({state.quiet().guard_token(WS)}) s:$(((()(g:({state.guard_none()})((g:({state.guard_none()})(#{classes!(" \t\r\n")}){g.accept_none()})*){g.accept_none()})))) {g.accept_token(s)})){g.accept_none()}))
    ...
    rule digit1_9() = ()(()(g:({state.guard_none()})((g:({state.quiet().guard_token(DIGIT1_9)}) s:$((#{classes!("1-9")})) {g.accept_token(s)})){g.accept_none()}))
    rule digit() = ()(()(g:({state.guard_none()})((g:({state.quiet().guard_token(DIGIT)}) s:$((#{classes!("0-9")})) {g.accept_token(s)})){g.accept_none()}) / expected!("digit"))
    ...
    rule hexdig() = ()(()(g:({state.guard_none()})((g:({state.quiet().guard_token(HEXDIG)}) s:$((#{classes!("0-9a-fA-F")})) {g.accept_token(s)})){g.accept_none()}))
    ...
    rule unescaped() = ()(()(g:({state.guard_none()})((g:({state.quiet().guard_token(UNESCAPED)}) s:$((#{classes!("\x20-\x21\x23-\x5B\x5D-\u{10ffff}")})) {g.accept_token(s)})){g.accept_none()}))
});
#[repr(u16)]
