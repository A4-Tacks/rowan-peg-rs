...
::peg::parser!(pub grammar parser<'b>(state: &'b ::rowan_peg_utils::ParseState<'input>) for str {
    ...
    rule comment() = ()(()(g:({state.guard_none()})((g:({state.quiet().guard_token(COMMENT)}) s:$(((()(g:({state.guard_none()})(";" (g:({state.guard_none()})([^::char_classes::any!(@"\n")]){g.accept_none()})*){g.accept_none()})))) {g.accept_token(s)})){g.accept_none()}) / expected!("comment"))
    ...
    rule ident() = ()(()(g:({state.guard_none()})((g:({state.quiet().guard_token(IDENT)}) s:$(((()(g:({state.guard_none()})(!(g:({state.quiet().guard_none()}) (quiet!{[::char_classes::any!(@"0-9")]}) {g.accept_none()}) (g:({state.guard_none()})((()(g:({state.guard_none()})([::char_classes::any!(@"0-9a-zA-Z_-")]){g.accept_none()}) / ()(g:({state.guard_none()})([^::char_classes::any!(@"\u{00}-\u{a0}")]){g.accept_none()}))){g.accept_none()})+){g.accept_none()})))) {g.accept_token(s)})){g.accept_none()}) / expected!("ident"))
    rule number() = ()(()(g:({state.guard_none()})((g:({state.quiet().guard_token(NUMBER)}) s:$(((()(g:({state.guard_none()})((g:({state.guard_none()})([::char_classes::any!(@"0-9")]){g.accept_none()})+){g.accept_none()})))) {g.accept_token(s)})){g.accept_none()}) / expected!("number"))
    rule string() = ()(()(g:({state.guard_none()})((g:({state.quiet().guard_token(STRING)}) s:$(((()(g:({state.guard_none()})("\"" (g:({state.guard_none()})([^::char_classes::any!(@"\"\r\n")]){g.accept_none()})* "\""){g.accept_none()})))) {g.accept_token(s)})){g.accept_none()}) / expected!("string"))
    rule matches() = ()(()(g:({state.guard_none()})((g:({state.quiet().guard_token(MATCHES)}) s:$(((()(g:({state.guard_none()})("<" (g:({state.guard_none()})([^::char_classes::any!(@"\x3e\r\n")]){g.accept_none()})* ">"){g.accept_none()})))) {g.accept_token(s)})){g.accept_none()}) / expected!("matches"))
