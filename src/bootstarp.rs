...
::peg::parser!(pub grammar parser<'b>(state: &'b ::rowan_peg_utils::ParseState<'input>) for str {
    ...
    rule whitespace() = ()()(g:({state.guard_none()})((g:({state.quiet().guard_token(WHITESPACE)}) s:$((quiet!{()(g:({state.guard_none()})((g:({state.guard_none()})(#{classes!(" \t\r\n")}){g.accept_none()})*){g.accept_none()})})) {g.accept_token(s)})){g.accept_none()})
    pub rule trivia() = _
    ...
    rule ident() = ()()(g:({state.guard_none()})((g:({state.quiet().guard_token(IDENT)}) s:$((quiet!{()(g:({state.guard_none()})(!(g:({state.quiet().guard_none()}) (quiet!{#{classes!("0-9")}}) {g.accept_none()}) (g:({state.guard_none()})(()(g:({state.guard_none()})(#{classes!("0-9a-zA-Z_-")}){g.accept_none()}) / ()(g:({state.guard_none()})(#{classes!(^"\u{00}-\u{a0}")}){g.accept_none()})){g.accept_none()})+){g.accept_none()})})) {g.accept_token(s)})){g.accept_none()}) / expected!("ident")
    rule number() = ()()(g:({state.guard_none()})((g:({state.quiet().guard_token(NUMBER)}) s:$((quiet!{()(g:({state.guard_none()})((g:({state.guard_none()})(#{classes!("0-9")}){g.accept_none()})+){g.accept_none()})})) {g.accept_token(s)})){g.accept_none()}) / expected!("number")
    rule string() = ()()(g:({state.guard_none()})((g:({state.quiet().guard_token(STRING)}) s:$((quiet!{()(g:({state.guard_none()})("\"" (g:({state.guard_none()})(#{classes!(^"\"\r\n")}){g.accept_none()})* "\""){g.accept_none()})})) {g.accept_token(s)})){g.accept_none()}) / expected!("string")
    rule matches() = ()()(g:({state.guard_none()})((g:({state.quiet().guard_token(MATCHES)}) s:$((quiet!{()(g:({state.guard_none()})("<" (g:({state.guard_none()})(#{classes!(^"\x3e\r\n")}){g.accept_none()})* ">"){g.accept_none()})})) {g.accept_token(s)})){g.accept_none()}) / expected!("matches")
    rule label() = (g:({state.guard(LABEL)}) (()(g:({state.guard_none()})(ident()){g.accept_none()}) / ()(g:({state.guard_none()})(string()){g.accept_none()})) {g.accept()})
    rule repeat_rest() = (g:({state.guard(REPEAT_REST)}) (()(g:({state.guard_none()})((g:({state.quiet().guard_token(STAR)}) s:$((quiet!{"*"})) {g.accept_token(s)}) (g:({state.guard_none()})(()(g:({state.guard_none()})(number()){g.accept_none()})){g.accept_none()})?){g.accept_none()})) {g.accept()})
    rule repeat() = (g:({state.guard(REPEAT)}) (()(g:({state.guard_none()})((g:({state.quiet().guard_token(PLUS)}) s:$((quiet!{"+"})) {g.accept_token(s)})){g.accept_none()}) / ()(g:({state.guard_none()})(number() (g:({state.guard_none()})(()(g:({state.guard_none()})(repeat_rest()){g.accept_none()})){g.accept_none()})?){g.accept_none()}) / ()(g:({state.guard_none()})(repeat_rest()){g.accept_none()})) {g.accept()})
    rule pat_expect() = (g:({state.guard(PAT_EXPECT)}) (()(g:({state.guard_none()})((g:({state.quiet().guard_token(AT)}) s:$((quiet!{"@"})) {g.accept_token(s)}) label()){g.accept_none()})) {g.accept()})
    rule pat_atom() = (g:({state.guard(PAT_ATOM)}) (()(g:({state.guard_none()})(ident() !(g:({state.quiet().guard_none()}) (quiet!{()(g:({state.guard_none()})(_() (g:({state.quiet().guard_token(EQ)}) s:$((quiet!{"="})) {g.accept_token(s)})){g.accept_none()})}) {g.accept_none()})){g.accept_none()}) / ()(g:({state.guard_none()})(string()){g.accept_none()}) / ()(g:({state.guard_none()})(matches()){g.accept_none()}) / ()(g:({state.guard_none()})((g:({state.quiet().guard_token(L_BRACK)}) s:$((quiet!{"["})) {g.accept_token(s)}) _() pat_choice() _() (g:({state.quiet().guard_token(R_BRACK)}) s:$((quiet!{"]"})) {g.accept_token(s)})){g.accept_none()}) / ()(g:({state.guard_none()})((g:({state.quiet().guard_token(L_PAREN)}) s:$((quiet!{"("})) {g.accept_token(s)}) _() pat_choice() _() (g:({state.quiet().guard_token(R_PAREN)}) s:$((quiet!{")"})) {g.accept_token(s)})){g.accept_none()})) {g.accept()})
    rule pat_op() = (g:({state.guard(PAT_OP)}) (()(g:({state.guard_none()})((g:({state.quiet().guard_token(AMP)}) s:$((quiet!{"&"})) {g.accept_token(s)}) pat_atom()){g.accept_none()}) / ()(g:({state.guard_none()})((g:({state.quiet().guard_token(BANG)}) s:$((quiet!{"!"})) {g.accept_token(s)}) pat_atom()){g.accept_none()}) / ()(g:({state.guard_none()})((g:({state.quiet().guard_token(TILDE)}) s:$((quiet!{"~"})) {g.accept_token(s)}) pat_atom()){g.accept_none()}) / ()(g:({state.guard_none()})((g:({state.quiet().guard_token(DOLLAR)}) s:$((quiet!{"$"})) {g.accept_token(s)}) pat_atom()){g.accept_none()}) / ()(g:({state.guard_none()})(repeat() _() pat_atom()){g.accept_none()}) / ()(g:({state.guard_none()})(pat_atom()){g.accept_none()})) {g.accept()})
    ...
    rule pat_choice() = (g:({state.guard(PAT_CHOICE)}) (()(g:({state.guard_none()})(pat_list() (g:({state.guard_none()})(()(g:({state.guard_none()})(_() (g:({state.quiet().guard_token(SLASH)}) s:$((quiet!{"/"})) {g.accept_token(s)}) _() pat_list()){g.accept_none()})){g.accept_none()})* (g:({state.guard_none()})(()(g:({state.guard_none()})(_() pat_expect()){g.accept_none()})){g.accept_none()})?){g.accept_none()})) {g.accept()})
    rule named() = (g:({state.guard(NAMED)}) (()(g:({state.guard_none()})(ident() _() (g:({state.quiet().guard_token(EQ)}) s:$((quiet!{"="})) {g.accept_token(s)}) _()){g.accept_none()})) {g.accept()})
    ...
    rule export_list() = (g:({state.guard(EXPORT_LIST)}) (()(g:({state.guard_none()})((g:({state.quiet().guard_token(EXPORTS_KW)}) s:$((quiet!{"exports"})) {g.accept_token(s)}) _() (g:({state.quiet().guard_token(L_BRACK)}) s:$((quiet!{"["})) {g.accept_token(s)}) _() (g:({state.guard_none()})(()(g:({state.guard_none()})(export() _()){g.accept_none()})){g.accept_none()})* (g:({state.quiet().guard_token(R_BRACK)}) s:$((quiet!{"]"})) {g.accept_token(s)})){g.accept_none()})) {g.accept()})
